...
import {ProviderType, Provider, Organization, Repository, Branch, SourceControls} from './deployment';
...
@Component({
    ...
    templateUrl: 'app/components/site/deploymentSource/deployment-source-setup.component.html',
    inputs: ["siteInput"],
...
export class DeploymentSourceSetupComponent {
    ...
    public ctrlGroup : ControlGroup = null
    ...
    constructor(private _portalService : PortalService,
       ...
       this._siteSubject = new Subject<ArmObj<Site>>();
        ...
        this.ctrlGroup = new ControlGroup({});
